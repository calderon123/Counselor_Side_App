...
public class FeedBackAdapter extends RecyclerView.Adapter <FeedBackAdapter.FeedBackViewHolder> {
    ...
    public FeedBackAdapter.FeedBackViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.my_feedbacks, viewGroup, false );
    ...
    public void onBindViewHolder(@NonNull final FeedBackViewHolder feedBackViewHolder, int i) {
        ...
        FirebaseDatabase.getInstance().getReference("UserMentee").child(rateDetails.getId()).child(rateDetails.getId())
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        UserMentee userMentee =dataSnapshot.getValue(UserMentee.class);

                        feedBackViewHolder.fullname.setText("from ID - "+userMentee.getId());
    ...
    public class FeedBackViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView comments_retrieve,date,fullname;
